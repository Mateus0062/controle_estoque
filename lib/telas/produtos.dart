    ...
    builder: (context, snapshot) {
      ...
      return AnimatedBuilder(animation: _busca, builder: (context, _) {
        ...
        return ListView(padding: const EdgeInsets.all(24), children: [
          ...
          Wrap(spacing: 10, runSpacing: 10, children: [SizedBox(width: 420, child: TextField(controller: _busca, onChanged: (_) => setState(() {}), decoration: const InputDecoration(hintText: 'Pesquisar por nome, código ou categoria', prefixIcon: Icon(Icons.search_rounded)))), ...['Todos','Normal','Baixo','Sem estoque'].map((f) => ChoiceChip(label: Text(f), selected: _filtro == f, onSelected: (_) => setState(() => _filtro = f))) ]),
